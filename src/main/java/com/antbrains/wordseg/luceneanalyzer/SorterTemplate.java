 ...
 * InsertionSort at the end. To use, subclass and override the four abstract methods which compare
 * and modify your data. Allows custom swap so that two arrays can be sorted at the same time.
 * 
 * @lucene.internal
 */
public abstract class SorterTemplate {
  ...
  /**
   * Compares slots {@code i} and {@code j} of you data. Should be implemented like
  ...
  /**
   * Implements the compare function for the previously stored pivot value. Should be implemented
   * like <code>pivot.compareTo(<em>valueOf(j)</em>)</code>
   */
  protected abstract int comparePivot(int j);

  /**
   * Sorts via stable in-place InsertionSort algorithm (ideal for small collections which are mostly
   * presorted).
   */
  ...
  /**
   * Sorts via in-place, but unstable, QuickSort algorithm. For small collections falls back to
   * {@link #insertionSort(int,int)}.
   */
