 ...
 * <p>
 * Consumers of this attribute call {@link #getBytesRef()} up-front, and then invoke
 * {@link #fillBytesRef()} for each term. Example:
 * 
 ...
 * </pre>
 * 
 * @lucene.experimental This is a very expert API, please use {@link CharTermAttributeImpl} and its
 *                      implementation of this method for UTF-8 terms.
 */
public interface TermToBytesRefAttribute extends Attribute {
  /**
   * Updates the bytes {@link #getBytesRef()} to contain this term's final encoding, and returns its
   * hashcode.
   * 
   ...
   * </pre>
   * 
   *         Implement this for performance reasons, if your code can calculate the hash on-the-fly.
   *         If this is not the case, just return {@code termBytes.hashCode()}.
   */
  public int fillBytesRef();

  /**
   * Retrieve this attribute's BytesRef. The bytes are updated from the current term when the
   * consumer calls {@link #fillBytesRef()}.
   * 
