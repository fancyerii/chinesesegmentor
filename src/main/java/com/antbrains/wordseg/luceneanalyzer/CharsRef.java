...
public final class CharsRef implements Comparable<CharsRef>, CharSequence {
  ...
  /**
   * Creates a new {@link CharsRef} and copies the contents of the source into the new instance.
   * 
   * @see #copy(CharsRef)
   */
  ...
  /**
   * Copies the given {@link CharsRef} referenced content into this instance starting at offset 0.
   * 
   * @param other
