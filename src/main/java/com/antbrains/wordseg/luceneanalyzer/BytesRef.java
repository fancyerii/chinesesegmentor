...
public final class BytesRef implements Comparable<BytesRef> {
  ...
  /**
   * @param text
   *          Initialize the byte[] from the UTF8 bytes for the provided Sring. This must be
   *          well-formed unicode text, with no unpaired surrogates or U+FFFF.
   */
  ...
  /**
   * @param text
   *          Initialize the byte[] from the UTF8 bytes for the provided array. This must be
   *          well-formed unicode text, with no unpaired surrogates or U+FFFF.
   */
  ...
  /*
   * // maybe? public BytesRef(BytesRef other, boolean shallow) { this(); if (shallow) { offset =
   * other.offset; length = other.length; bytes = other.bytes; } else { copy(other); } }
   */
   ...
   * 
   * @param text
   *          Must be well-formed unicode text, with no unpaired surrogates or invalid UTF16 code
   *          units.
   */
