...
public interface CharTermAttribute extends Attribute, CharSequence, Appendable {
   ...
   * <p>
   * The characters of the {@code String} argument are appended, in order, increasing the length of
   ...
   * <p>
   * The characters of the {@code StringBuilder} argument are appended, in order, increasing the
   ...
   * <p>
   * The characters of the {@code CharTermAttribute} argument are appended, in order, increasing the
   * length of this sequence by the length of the argument. If argument is {@code null}, then the
   * four characters {@code "null"} are appended.
   */
