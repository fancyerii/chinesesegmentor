...
public abstract class Tokenizer extends TokenStream {
  ...
  /**
   * Return the corrected offset. If {@link #input} is a {@link CharStream} subclass this method
   * calls {@link CharStream#correctOffset}, else returns <code>currentOff</code>.
   * 
   * @param currentOff
  ...
  /**
   * Expert: Reset the tokenizer to a new reader. Typically, an analyzer (in its reusableTokenStream
   * method) will use this to re-use a previously created tokenizer.
   */
