...
public interface OffsetAttribute extends Attribute {
   ...
   * 
   * Note that the difference between endOffset() and startOffset() may not be equal to
   * termText.length(), as the term text may have been altered by a stemmer or some other filter.
   */
