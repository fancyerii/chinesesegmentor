...
public class FileTools {
  ...
  public static void writeCollections(String filePath, Collection<String> list, String encoding)
      throws IOException {
    BufferedWriter bw = null;
    try {
  ...
  public static void writeList(String filePath, List<String> list, String encoding)
      throws IOException {
    BufferedWriter bw = null;
    try {
      bw = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(filePath), encoding));
  ...
  public static Map<String, Double> readFile2StringDoubleMap(String filePath, String encoding,
      String sep, boolean keyToLowercase) throws IOException {
